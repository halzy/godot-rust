...
pub fn generate_class_impl(
    ...
    let class_singleton = special_methods::generate_singleton_getter(class);
    let class_singleton_getter = special_methods::generate_gdnative_library_singleton_getter(class);
